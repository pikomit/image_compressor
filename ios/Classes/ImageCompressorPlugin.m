#import "ImageCompressorPlugin.h"
#import "CompressListHandler.h"
#import "CompressFileHandler.h"

BOOL showLog = false;

@implementation ImageCompressorPlugin
...
+ (void)registerWithRegistrar:(NSObject <FlutterPluginRegistrar> *)registrar {
    ...
    FlutterMethodChannel *channel = [FlutterMethodChannel
            methodChannelWithName:@"fr.supernovae.pikomit.image_compressor"
                  binaryMessenger:[registrar messenger]];
    ImageCompressorPlugin *instance = [[ImageCompressorPlugin alloc] init];
